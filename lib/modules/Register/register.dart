...
import '../pages/operationOrder.dart';
                          ...
                          Form(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                ShopCubit.get(context).isValid == null || ShopCubit.get(context).isValid==true ?height(0):height(15),
                                ShopCubit.get(context).isValid == false ? Padding(
                                  padding: const EdgeInsets.only(left: 20, right: 20),
                                  child:ShopCubit.get(context).isValid == null?SizedBox(height: 0): Text('كود دعوة غير صحيح !',style: TextStyle(color:Colors.red,fontWeight: FontWeight.w500,fontSize: 13),),
                                ):SizedBox(height: 0),
                                height(25),
                                Padding(
                                  padding: const EdgeInsets.only(left: 20, right: 20),

...
class RestaurantPage extends StatefulWidget {
  ...
  _RestaurantPageState createState() => _RestaurantPageState();
    ...
    Widget build(BuildContext context) {
      ...
      return BlocProvider(
        create: (BuildContext context) => ShopCubit()..getStoreData(
            slug:widget.slug,
          )..getCartItem(),
                          ...
                          child: Container(
                            ...
                            child: Column(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        width(2),
                                        Text('${cubit.store['offers'].where((e)=>e['type'] != 'freeDeliveryFirstOrder' && e['type'] != 'freeDelivery').toList()[0]['ar']['name']}',
                                          style: TextStyle(
                                              fontSize: 16,
                                              fontWeight: FontWeight.bold,
                                              color: Colors.black,
                                  ...
                                  cubit.store['offers'].where((e)=>e['type'] != 'freeDeliveryFirstOrder' && e['type'] != 'freeDelivery').toList()[0]['ar']['description']==''?height(0):Padding(
                                    padding:EdgeInsets.only(right: 10,top: 0,bottom: 5),
                                    child: Text('${cubit.store['offers'].where((e)=>e['type'] != 'freeDeliveryFirstOrder' && e['type'] != 'freeDelivery').toList()[0]['ar']['description']}'),
                                  ),
                                  height(5),
                                            ...
                                            child: Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Column(
                                                    children: [
                                                     service_type=='food'?ListView.builder(
                                                          shrinkWrap: true,
                                                          physics: NeverScrollableScrollPhysics(),
                                                             ...
                                                             child:Column(
                                                               ...
                                                               children:[
                                                                 InkWell(
                                                                   ...
                                                                   child: Container(
                                                                     child:product['image']!=''?CachedNetworkImage(
                                                                         height: 150,
                                                                         width: 150,
                                                                         imageUrl: '${product['image']}',
                                                                         placeholder: (context, url) =>

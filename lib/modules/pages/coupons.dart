...
class Couponds extends StatefulWidget {
  const Couponds({Key key}) : super(key: key);

  @override
  State<Couponds> createState() => _CoupondsState();
}

class _CoupondsState extends State<Couponds> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context) => ShopCubit()..GetCoupons(),

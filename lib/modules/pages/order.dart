...
import 'package:shopapp/modules/pages/support_service.dart';
          ...
          builder: (context,Setstate){
            return Column(
              ...
              children: [
                Align(
                  ...
                  child: Padding(
                    ...
                    child: TextButton(
                      ...
                      child:isCancel?Text('الغاء الطلب',style: TextStyle(
                ...
                height(10),
                Text('عملية الدفع فشلت',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold)),
                height(10),
                Padding(
                  padding: const EdgeInsets.only(left: 15,right: 15),
                  child: Text('أُووبس! يبدو أن هناك مشكلة في دفعتك! يرجى تواصل معنا من اجل لمزيد من المعلومات',style: TextStyle(color: Colors.grey[600],fontWeight: FontWeight.w500,height: 1.5),textAlign: TextAlign.center),
                ),
                height(20),
                Padding(
                 padding: const EdgeInsets.all(8.0),
                   ...
                   children: [
                     widget.order['data']['store']['payment_methods'].contains('CASH')?Padding(
                       ...
                       child: Container(
                         ...
                         child:isPaymentChange?TextButton(
                           ...
                           child:Text('دفع نقدا',style: TextStyle(
                               color: Colors.white,
                     ...
                     Padding(
                       ...
                       child: Container(
                         ...
                         child: TextButton(
                           onPressed: () {
                             navigateTo(context, Payment(refCode:int.parse(widget.order['data']['order_ref'])));
                           },
                           child: Text('اعادة محاولة',style: TextStyle(
                               color: Colors.black,
                               fontWeight: FontWeight.w500
                           )),
                         ),
  ...
  void initState() {
    Future.delayed(Duration(seconds:1),(){
      if(widget.order['data']["delivery_status"] != "delivered" && msg != 'تم إلغاء طلبيتك'){
        if(widget.order['data']['payment_status'] == 'semi_paid' && widget.order['data']['payment_method']=='CARD')
          _showAlert(context);
      }
          ...
          body: Stack(
            children: [
              Positioned.fill(
                ...
                child: Image.asset(
                  img,
                  fit:msg == 'تم إلغاء طلبيتك'?BoxFit.cover
                      : BoxFit.cover,
                ),
              ),
              Positioned(
                      ...
                      children:[
                        Column(
                         ...
                         msg == 'تم إلغاء طلبيتك'?Padding(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    widget.order['data']["delivery_status"] == "delivered" ?height(0):msg != 'تم إلغاء طلبيتك'?Row(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      children: [
                                      ...
                                      Padding(
                                        ...
                                        child: GestureDetector(
                                              ...
                                              return Column(
                                                ...
                                                children: [
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Text(DemoLocalization.of(context).getTranslatedValue('Contactez_le_livreur'),style: TextStyle(
                                                        fontWeight: FontWeight.bold,
                                                        fontSize: 19
                                                    ),),
                                                  ),
                                                  ...
                                                  Padding(
                                                    padding:EdgeInsets.only(left: 15,right: 15,top: 10),
                                                    child: Text(DemoLocalization.of(context).getTranslatedValue('En_route'),style: TextStyle(
                                                      fontWeight: FontWeight.w400,
                                                      fontSize: 15,
                                                    ),),
                                                  ),
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: Row(
                                                          ...
                                                          children: [
                                                            ...
                                                            width(7),
                                                            Text(DemoLocalization.of(context).getTranslatedValue('Appel'),style: TextStyle(
                                                                fontWeight: FontWeight.bold,
                                                                color: Colors.white,
                                                                fontSize: 17
                                                            ),),
                                          ...
                                          child: Row(
                                            ...
                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                            children: [
                                              Text(DemoLocalization.of(context).getTranslatedValue('Contactez_les'),style: TextStyle(
                                                  fontSize: 16,
                                                  fontWeight: FontWeight.w500
                                              ),),
                            ...
                            // if(widget.order['data']['payment_status'] == 'semi_paid')
                            // Padding(
                            ...
                            //           width(5),
                            //           Text('لم يتم دفع عن طريق البطاقة',style: TextStyle(
                            //               color: Colors.black,
                            //               fontWeight: FontWeight.bold,
                            //               fontSize: 15
                            //           )),
                            ...
                            //                  width(1),
                            //                  Text('حاول مجددا',style: TextStyle(
                            //                    color: Colors.white,
                            //                  ),)
                            //                ],
                            //              )),
                            ...
                            //               }, child:Row(
                            //                 children: [
                            //                   Icon(Icons.support_agent,color: AppColor),
                            //                   width(2),
                            ...
                            Container(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  //   child:Text(DemoLocalization.of(context).getTranslatedValue('Détails_de_paiement'),style: TextStyle(fontSize: 18,color: Colors.black,fontWeight: FontWeight.w500)),
                                  // ),
  ...
  StepperData Stepper(
    ...
    return StepperData(
        title: StepperText(
          title,
          textStyle:
              TextStyle(color: color, fontSize: 12.5, fontWeight: fontWeight),
        ),

...
import '../../modules/pages/checkout_page.dart';
...
class MyHomePage extends StatefulWidget {
  ...
  const MyHomePage({Key key,this.myLocation,this.latitude,this.longitude,this.category}) : super(key: key);
  @override
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> GetCategories() async{
    ...
    http.Response response = await http.get(Uri.parse('https://api.canariapp.com/v1/client/categories?type=${service_type}&locale=fr'),
      ...
      child: BlocConsumer<ShopCubit, ShopStates>(
        listener: (context, state) {
          ...
          if(state is GetFilterDataLoadingState){
            ...
            setState(() {
              navigateTo(context, Filters(text: text,Categories:Categories));
            });
          }
        },
                ...
                body:SingleChildScrollView(
                    child:Column(
                      ...
                      children:[
                        ...
                        height(9),
                        Sliders(selectFilters:selectFilters),
                        height(0),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                        ...
                        height(14),
                        Category(cubit: cubit,selectFilters:selectFilters,Categories: Categories,isCategoriesLoading:isCategoriesLoading),
                        height(5),
                                                    ...
                                                    children: [
                                                      Stack(
                                                        children: [
                                                          ...
                                                          //             child: Text('احصل على 25٪',style: TextStyle(
                                                          //                 color: Colors.white,
                                                          //                 fontWeight: FontWeight.bold,
                                                          //                 fontSize: 10
                                                          //             ),),
                      ...
                      Container(
                                          ...
                                          child: Container(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Container(
                                                        ...
                                                        child: ClipRRect(
                                                          borderRadius: BorderRadius.circular(10),
                                                          child:CachedNetworkImage(
                                                              imageUrl: '${cubit.storesNear[index]['logo']}',
                                                ...
                                                Padding(
                                                  padding:EdgeInsets.only(left: 12,right: 10,top:cubit.storesNear[index]['delivery_time']==null?9:0),
                                                  child: Column(
                                                    crossAxisAlignment: CrossAxisAlignment.start,
                                                    mainAxisAlignment: MainAxisAlignment.center,
                                                    children: [
                                                      ...
                                                      cubit.PriceDeliverys.where((item)=>item['store_id']==cubit.storesNear[index]['id']).toList().length>0?Row(
                                                        ...
                                                        mainAxisAlignment: MainAxisAlignment.start,
                                                        children: [
                                                          Icon(Icons.star,color:cubit.storesNear[index]['rate']>=3.5?Colors.green:Colors.grey[300],size:18),
                                                          width(5),
                                                          ...
                                                          width(4),
                                                          Icon(Icons.delivery_dining_outlined,color:cubit.PriceDeliverys.where((item)=>item['store_id']==cubit.storesNear[index]['id']).toList()[0]['delivery_price']!=0?Colors.black:AppColor,size: 14,),
                                                          width(5),
                                                          Text(
                                                              cubit.PriceDeliverys.where((item)=>item['store_id']==cubit.storesNear[index]['id']).toList()[0]['delivery_price']!=0?'${cubit.PriceDeliverys.where((item)=>item['store_id']==cubit.storesNear[index]['id']).toList()[0]['delivery_price']} ${DemoLocalization.of(context).getTranslatedValue('MAD')} ':DemoLocalization.of(context).getTranslatedValue('livraison_gratuite'),
                                                              style: TextStyle(
                                                                  fontSize:11.5,
                                                                  color:cubit.PriceDeliverys.where((item)=>item['store_id']==cubit.storesNear[index]['id']).toList()[0]['delivery_price']!=0?  Color.fromARGB(255, 78, 78, 78):AppColor,
                                                                  fontWeight: FontWeight.w400)
                                                          ),
                                                        ],
                                                      ):Row(
                        ...
                        height(15),
                        restaurantsWithDiscount.length>0?Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            title(text:DemoLocalization.of(context).getTranslatedValue('Meilleures_offres'),size: 16,color:Colors.black),
                          ],
                        ):height(0),
                        restaurantsWithDiscount.length>0?height(15):height(0),
                        restaurantsWithDiscount.length>0?BuildCondition(
                          condition:cubit.isNearStoresLoading,
                          builder: (context){
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Container(
                                                        ...
                                                        child: ClipRRect(
                                                          borderRadius: BorderRadius.circular(10),
                                                          child:CachedNetworkImage(
                                                              imageUrl: '${restaurantsWithDiscount[index]['logo']}',
                                                              placeholder: (context, url) => Image.asset('assets/placeholder.png',fit: BoxFit.cover,),
                                                              errorWidget: (context, url, error) =>  Image.asset('assets/placeholder.png',fit: BoxFit.cover,),
                                                              imageBuilder: (context, imageProvider){
                                                                return Container(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      cubit.ispriceLoading?Row(
                                                        ...
                                                        mainAxisAlignment: MainAxisAlignment.start,
                                                        children: [
                                                          restaurantsWithDiscount[index]['reviews_count']<10?height(0):Icon(Icons.star,color:restaurantsWithDiscount[index]['rate']>=3.5?Colors.yellow:Colors.grey[300],size:18),
                                                          restaurantsWithDiscount[index]['reviews_count']<10?height(0):width(5),
                                                          restaurantsWithDiscount[index]['reviews_count']<10?height(0): Text('${restaurantsWithDiscount[index]['rate'].toStringAsFixed(1)}',style: TextStyle(
                                                              color:restaurantsWithDiscount[index]['rate']>=3.0?Colors.green:Colors.grey,
                                                              fontSize: 12
                                                          ),),
                                                          restaurantsWithDiscount[index]['reviews_count']<10?height(0):width(5),
                                                          restaurantsWithDiscount[index]['reviews_count']<10?height(0):Text(DemoLocalization.of(context).getTranslatedValue('excellent'),style: TextStyle(
                                                              color:restaurantsWithDiscount[index]['rate']>=3.0?Colors.green:Colors.grey,
                                                              fontSize: 12
                                                          ),),
                                                          restaurantsWithDiscount[index]['reviews_count']<10?height(0):width(5),
                                                          restaurantsWithDiscount[index]['reviews_count']<10?height(0):rate(restaurantsWithDiscount[index]['reviews_count'],restaurantsWithDiscount[index]),
                                                          restaurantsWithDiscount[index]['reviews_count']<10?height(0):width(5),
                                                          restaurantsWithDiscount[index]['reviews_count']<10?height(0):Padding(
                                                          ...
                                                          Icon(Icons.delivery_dining_outlined,color:cubit.PriceDeliverys.where((item)=>item['store_id']==restaurantsWithDiscount[index]['id']).toList()[0]['delivery_price']!=0?Colors.black:AppColor,size: 14,),
                                                          width(5),
                                                          Text(
                                                              cubit.PriceDeliverys.where((item)=>item['store_id']==restaurantsWithDiscount[index]['id']).toList()[0]['delivery_price']!=0?'${cubit.PriceDeliverys.where((item)=>item['store_id']==restaurantsWithDiscount[index]['id']).toList()[0]['delivery_price']} ${DemoLocalization.of(context).getTranslatedValue('MAD')} ':DemoLocalization.of(context).getTranslatedValue('livraison_gratuite'),
                                                              style: TextStyle(
                                                                  fontSize:11.5,
                                                                  color:cubit.PriceDeliverys.where((item)=>item['store_id']==restaurantsWithDiscount[index]['id']).toList()[0]['delivery_price']!=0?  Color.fromARGB(255, 78, 78, 78):AppColor,
                                                                  fontWeight: FontWeight.w400)
                                                          ),
                                                        ],
                                                      ):Row(
                        ...
                        cubit.stores.length>0?Row(
                          ...
                          children: [
                            Padding(
                              ...
                              child: title(text:DemoLocalization.of(context).getTranslatedValue('Tous_les_restaurants'),size: 16,color:Colors.black),
                            ),
                            height(7),
                            Padding(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                ...
                                if (index == cubit.stores.length ~/ 3) {
                                  ...
                                  return  Padding(
                                    ...
                                    child: ResturantList(Restaurant:item,id:item['id'],ispriceLoading: cubit.ispriceLoading,PriceDeliverys: cubit.PriceDeliverys),
                                  );
                                } else {
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  if (index == cubit.stores.length ~/ 2) {
                                    ...
                                    return  Padding(
                                      ...
                                      child: ResturantGridl(Restaurant:item,id:item['id'],ispriceLoading:cubit.ispriceLoading,PriceDeliverys: cubit.PriceDeliverys),
                                    );
                                  } else {
                                    final item = cubit.stores[index];
                                    return Padding(

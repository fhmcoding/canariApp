                ...
                child: Row(
                  ...
                  children: [
                    ...
                    widget.coupon['delivery_amount']==null?Text(
                      ...
                      children: [
                        Text(widget.coupon['delivery_amount']=="0.00"?" توصيل مجاني  ":" ${widget.coupon['delivery_amount']} دراهم ",style: TextStyle(
                            color:Colors.green,
                            fontSize:13,
                            fontWeight:FontWeight.w600
                        ),),
                        Text("${deliveryPrice} دراهم ",style: TextStyle(
                            fontSize:13,
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                        " ${widget.order[0]['weather_fee']} دراهم ",
                        style:TextStyle(fontWeight:FontWeight.w500,color:Color(0xFF587081))
                    )
                  ],
                ),
                ...
                Padding(
                  ...
                  child:Row(
                    ...
                    children: [
                      ...
                      Text(
                          "${(widget.order[0]['service_fee']).toStringAsFixed(2)} دراهم ",
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                        widget.method_payment=='cash'?'الدفع عند الاستلام':'الدفع عن طريق البطاقة',
                        style: TextStyle(fontWeight: FontWeight.w500,color: Color(0xFF587081),)
                    )
                  ],
                ),
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    widget.coupon['order_amount']==null?Column(
                      children: [
                        widget.coupon['delivery_amount']==null?Text(
                            widget.coupon['percentage']==null?"${(widget.total + deliveryPrice).toStringAsFixed(2)} دراهم ":"${(deliveryPrice + widget.total - (widget.total*calculatepercentage(widget.coupon['percentage']))).toStringAsFixed(2)} دراهم ",
                            style: TextStyle(fontWeight: FontWeight.bold,color: Color(0xFFde2706),)
                        ):Text('${(double.tryParse(widget.coupon['delivery_amount']) + widget.total).toStringAsFixed(2)} دراهم ',style: TextStyle(fontWeight: FontWeight.bold,color: Color(0xFFde2706),)),
                      ],
                    ):Text("${double.parse(widget.coupon['order_amount'])} دراهم ",style: TextStyle(
                   ...
                   seconds == 30?height(0):Center(
                     child: GestureDetector(
                       ...
                       child: Container(
                         ...
                         child: Center(
                           child: Text('الغاء الطلب',style: TextStyle(
                               fontSize: 16,
                   ...
                   Row(
                     ...
                     children: [
                       Padding(
                         ...
                         child: Text('جاري إنشاء طلبك ',style: TextStyle(
                             fontSize: 25,
                             fontWeight: FontWeight.bold,
                             color: Colors.black
                         )),
                       ...
                       Stack(
                         ...
                         children: [
                           ...
                           load?Positioned(child: Icon(Icons.check,size: 40,color:Color(0xff40826d)),right: 15,):height(0)
                         ],
                       ),
                     ],
                   ),

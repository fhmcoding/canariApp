...
import '../modules/pages/offer.dart';
import '../modules/pages/orderdelivery.dart';
import '../modules/pages/share.dart';
import '../modules/pages/web.dart';
...
class _SlidersState extends State<Sliders> {
  ...
  Widget build(BuildContext context) {
    printFullText(sliders.toString());
                        ...
                        child: GestureDetector(
                          onTap: ()async{
                            ...
                            if(item['type']=='category'){
                              navigateTo(context, Filters(text:item['value']));
                            }

      ...
      child: Container(
       ...
       child: Column(
         ...
         children: [
           ...
           Padding(
             padding:EdgeInsets.only(left: 12,right: 10,top:widget.Restaurant['delivery_time']==null?9:0),
             child: Column(
               crossAxisAlignment:CrossAxisAlignment.start,
               mainAxisAlignment:MainAxisAlignment.center,
               children:[
                ...
                height(2),
                 widget.PriceDeliverys.where((item)=>item['store_id']==widget.Restaurant['id']).toList().length>0?Row(
                   ...
                   children:[
                     ...
                     // widget.size==140?buildReview():height(0),
                     // widget.size==140?widget.Restaurant['reviews_count']<10?height(0):width(5):height(0),
                     // widget.size==140?widget.Restaurant['reviews_count']<10?height(0):Container(
                     //   height: 5,
                     //   width: 5,
                     //   decoration: BoxDecoration(
                     //       color: Colors.grey[300],
                     ...
                     //   ),
                     // ):height(0),
                     // widget.size!=140?widget.Restaurant['reviews_count']<10?height(0):buildReview():height(0),
                     // widget.size!=140?widget.Restaurant['reviews_count']<10?height(0):width(5):height(0),
                     // widget.size!=140?widget.Restaurant['reviews_count']<10?height(0):Container(
                     //   height: 5,
                     //   width: 5,
                     ...
                     // ):height(0),
                     width(4),
                     widget.size==140?widget.Restaurant['reviews_count']<10?height(0):width(7):height(0),
                     Icon(Icons.delivery_dining_outlined,color:widget.PriceDeliverys.where((item)=>item['store_id']==widget.Restaurant['id']).toList()[0]['delivery_price']!=0?Colors.black:AppColor,size: 14,),
                      width(5),
                     Text(
                         widget.PriceDeliverys.where((item)=>item['store_id']==widget.Restaurant['id']).toList()[0]['delivery_price']!=0?'${widget.PriceDeliverys.where((item)=>item['store_id']==widget.Restaurant['id']).toList()[0]['delivery_price']} ${DemoLocalization.of(context).getTranslatedValue('MAD')} ':DemoLocalization.of(context).getTranslatedValue('livraison_gratuite'),
                        style: TextStyle(
                         fontSize:11.5,
                         color:widget.PriceDeliverys.where((item)=>item['store_id']==widget.Restaurant['id']).toList()[0]['delivery_price']!=0?  Color.fromARGB(255, 78, 78, 78):AppColor,
    ...
    if (rate_count > 20) {
      ...
      return Row(
        ...
        children: [
          ...
          Text(')',style: TextStyle(
            color: widget.Restaurant['rate']>=3.0?Colors.green:Colors.grey,
          ),),
        ],
      );
    } else {

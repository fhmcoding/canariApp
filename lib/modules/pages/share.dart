    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          height(30),
          Text('شارك تطبيق وحصل على توصيل مجاني',style: TextStyle(
            fontSize: 16,
          ...
          Padding(
            ...
            child: Text(' احصل على توصيل مجاني عن طريق مشاركة التطبيق مع 3 أصدقائك لي يحصلو اصدقائك على توصيل مجاني ايضا',style: TextStyle(
              fontSize: 15,
              height: 2,
              fontWeight: FontWeight.bold,

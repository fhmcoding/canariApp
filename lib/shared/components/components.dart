        ...
        child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              return GestureDetector(
                onTap: (){
                  navigateTo(context, Filters(text:Categories[index]['name'],Categories:Categories));
                  },
                child: Column(
                  children: [
                    Container(
...
Widget Summary(BuildContext context,ShopCubit cubit,{Function ontap,String rout,isloading, bool isAccpted}){
  return Container(
    height: 80,
    decoration: BoxDecoration(
        color: Colors.white,
    ...
    child: Padding(
      ...
      child: Column(
        ...
        children: [
          GestureDetector(
            onTap:ShopCubit.get(context).isloading?isloading?ontap:(){
              print('object');
            }:(){
              print('object');
            },
          ...
          child:ListView.builder(
              ...
              itemBuilder: (context, index){
                return Padding(
                  ...
                  child: ResturantGridl(Restaurant:newStores[index],id:newStores[index]['id'],size: 140.0,ispriceLoading:ispriceLoading,PriceDeliverys:PriceDeliverys),
                );
              }),
        ),
      );

            ...
            child:ListView.builder(
              ...
              itemBuilder: (context, index){
                return Padding(
                  ...
                  child: ResturantGridl(ispriceLoading:cubit.ispriceLoading,Restaurant:tag == 'new'?status=='freedelivery'?cubit.stores.where((element) => element['delivery_price']==0).toList()[index]:cubit.stores[index]:cubit.stores[index],id:cubit.stores[index]['id'],size: 140.0,PriceDeliverys:cubit.PriceDeliverys),
                );
              }),
          ),
        );
